...
public abstract class Training {
	// ending condition
	private int epochs; // training cycle generation
	private double error; // link btwn estimated output & real output 
	private double mse; // risk planned observation,

	public enum TrainingTypesENUM { //training types
		PERCEPTRON, ADALINE;
	}

	/**
	* Produce a trained neural network with weight from an other neuralnet
	* @param n neuron quantities
	*/
	public NeuralNet train(NeuralNet n) {
		...
		while (this.getEpochs() < n.getMaxEpochs()) {
			...
			// train over all the samples present in the network
			...
			//compare output to estimated output and calculate error
